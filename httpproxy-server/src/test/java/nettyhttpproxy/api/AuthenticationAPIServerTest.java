...
import nettyhttpproxy.utils.RawHttpClient.BasicAuthCredentials;
import nettyhttpproxy.utils.RawHttpClient.HttpResponse;
...
public class AuthenticationAPIServerTest extends UseAdminServer {
    ...
    public void testUnauthorizedRequests() throws Exception {
        ...
        prop.put("userrealm.class", "nettyhttpproxy.utils.TestUserRealm");
