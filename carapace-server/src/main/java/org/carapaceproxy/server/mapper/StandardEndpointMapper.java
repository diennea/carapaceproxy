    ...
    public void configure(ConfigurationStore properties) throws ConfigurationNotValidException {
        ...
        for (int i = 0; i <= max; i++) {
            ...
            if (!id.isEmpty() && enabled) {
                ...
                final var headersIds = properties.getValues(prefix + "headers", Collections.emptySet());
        ...
        for (int i = 0; i <= max; i++) {
            ...
            if (!id.isEmpty()) {
                ...
                if (enabled) {
                    ...
                    for (String backendId : properties.getValues(prefix + "backends", Collections.emptySet())) {
