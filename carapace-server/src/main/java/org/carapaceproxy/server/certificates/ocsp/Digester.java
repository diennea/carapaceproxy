...
/**
 * BC's {@link OCSPReqBuilder} needs a {@link DigestCalculator} but BC doesn't provide any public implementations of that interface. That's why we need to write our own. There's a default SHA-1
 * implementation and one for SHA-256. Which one to use will depend on the Certificate Authority (CA).
 */
